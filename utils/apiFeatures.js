//implementing the search feature class
...
class APIFeatures {
  ...
  filter = () => {
    ...
    //we are initializing  and removeing them because these three will be on our url and when we are searching for service with the  category they should be opt out
